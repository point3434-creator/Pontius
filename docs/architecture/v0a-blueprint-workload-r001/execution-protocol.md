...
Run from fresh non-reparse D-local exact-source snapshots. Preserve all B tracked
raw blobs outside the six declared exceptions and additive paths. Recheck the
