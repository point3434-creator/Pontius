...
- Session/profile: real empty and one-entry sessions at seats 0 and 3 in both
  strategies, with observational diagnostic counterparts (eight plus eight maximum
  per interpreter for source qualification). Verify source admission, unmodified
