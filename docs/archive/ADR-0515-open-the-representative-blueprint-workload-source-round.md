...
must bind the sealed source, runtimes, exact qualification recipe/protocol and
one absent result root. Its staged authority requires the derived population/plan
identities to be frozen before the first measured worker; it does not require
those derived hashes before authorizing their value-free construction.
The full 8,192/1,152-trajectory population construction and
