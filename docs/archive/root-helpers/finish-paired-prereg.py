...
assert candidate == '4c7882752bd93e56a05dba513c035b02ca2f2325'
...
summary = dict(candidate=identity, reviews=reviews, gates=gates,
    ...
    reserved_root_absent=True, rehearsal_invocations=0,
    standing='Prepared for exact decision commit/push and single rehearsal launch approval; not adopted')
raw = (json.dumps(summary, indent=2, sort_keys=True)+'\n').encode()
save(packet/'acceptance-summary.json', raw)
disposition = f'''# Disposition: v0a-paired-prereg/r001
...
No production source changed, rehearsal ran, run root was created, or decision adopted.
Ready to request exact decision commit/push and the separately named single rehearsal.
