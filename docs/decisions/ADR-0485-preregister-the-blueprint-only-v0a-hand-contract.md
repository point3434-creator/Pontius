...
totals are final public-ledger totals only when fully measured; each is null
if its measurement could not be completed, never zero or a prefix presented
as the final total. Other failures that prevent hand-accounting completion
