...
for trial in range(40):
    n,m = 3,4
    weights = [[rng.randrange(0,8) for j in range(m)] for i in range(n)]
...
out['pure_response_trials']=40; out['cfr_scalar_local_steps']=800; out['max_pure_response_absolute_error']=max_error
