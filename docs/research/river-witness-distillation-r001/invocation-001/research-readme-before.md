...
## Witness-feature distillation candidate

[Design](river-witness-distillation.md) and
[reviewed packet](river-witness-distillation-r001/disposition.md) define a fixed comparison
using eight observed training boards and eight reserved evaluation boards. The
48-case comparison awaits separate approval for fitting and evaluation.
