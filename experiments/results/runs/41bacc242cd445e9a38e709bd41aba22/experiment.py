...
def play(source, game, projected, first, second, player, mode, board, source_hash, supported):
    ...
    while not state.is_terminal:
        ...
        if controlled:
            ...
            assert decision.applied_action == HandAction.from_betting_action(action)
            assert decision.delivered_action == decision.applied_action
            ...
            decisions.append(
                dict(
                    ...
                    action=asdict(decision.applied_action),
