...
from pontius.holdem_cards import OneSeatCardState, SixSeatHoldemDeal, format_card
        ...
        save(
            ...
            dict(
                ...
                hands=[
                    dict(
                        private_hands=[
                            [format_card(card) for card in hand] for hand in deal.private_hands
                        ],
                        board_runout=[format_card(card) for card in board],
                    )
                ],
            ),
        )
