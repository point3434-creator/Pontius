...
REPORT = e.ROOT/'docs/research/river-full-combo-direct-002.md'
...
shutil.copytree('D:/Pontius-training/river-abstraction-study/full-combo-direct-001',
                ARCHIVE/'superseded-attempt/results')
shutil.copytree('D:/Pontius/tmp/full-combo-direct-author',
                ARCHIVE/'superseded-attempt/author', ignore=shutil.ignore_patterns('__pycache__'))
...
index.write_bytes(old+('\n## Full-hand direct river solving\n\n'
    '[Direct comparison 002](river-full-combo-direct-002.md) measures full 1081-hand LP\n'
