"""Verify saved holdout policies against original RiverState terminal returns."""
...
OUT = Path('D:/Pontius-training/river-abstraction-study/holdout-001')
ANALYSIS = Path('D:/Pontius/tmp/holdout-author/holdout-analysis.json')
...
summary = {'kind': 'verified fixed holdout trial; original-state scalar recomputation',
