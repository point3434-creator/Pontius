...
def prepare():
    ...
    reference = HISTORY/'river-tree-expansion-001/run/001-baseline.json'
    ...
    plan = dict(name='river-cfr-comparison-001', frozen_at=datetime.now(timezone.utc).isoformat(),
                source_commit='6518b9d3af252c93f8a9dbdb13fb28adc2859b4c',
                context_checkout='D:/Pontius-worktrees/eval-runner-consolidation',
                authorization='User: Let\'s run the comparisons', case=1, variant='baseline',
