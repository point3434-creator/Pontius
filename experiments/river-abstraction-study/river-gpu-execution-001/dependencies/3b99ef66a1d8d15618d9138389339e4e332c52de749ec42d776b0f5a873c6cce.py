...
def prepare():
    ...
    plan = dict(name='river-cfr-expanded-001-checkback', frozen_at=datetime.now(timezone.utc).isoformat(),
                source_commit='6518b9d3af252c93f8a9dbdb13fb28adc2859b4c',
                context_checkout='D:/Pontius-worktrees/eval-runner-consolidation',
                authorization='User: Let\'s test it', case=1, variant='checkback',
