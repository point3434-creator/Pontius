"""Record this controller approval and execute the frozen 48-case pilot plan once."""
...
DIGEST = '535a3fa5b4d55d8bc6cc29763c63b5ab41f89cf0ea190bca90f9c00a5a8c9d2c'
...
spec = importlib.util.spec_from_file_location('bound_screen', ROOT/'tools/river_witness_pilot.py')
...
write(EVIDENCE/'authorization.json', dict(user_words_verbatim='I approve',
    context='Reply to the explicit request for one execution of the reviewed bound 48-case pilot plan.',
    plan_path=str(PLAN), plan_sha256=DIGEST,
    scope='One 48-case pilot invocation only; no retry, commit, push or later experiment.',
