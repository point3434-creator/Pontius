"""Self-contained repository launcher for the ADR-0427 V3 owner."""
...
def _resolved_repository() -> tuple[Path, Path]:
    ...
    if (
        ...
        raise RuntimeError("shared-direct V3 repository geometry differs")
    return root, source


def main() -> None:
    if len(sys.argv) != 1:
        raise SystemExit("shared-direct V3 launcher accepts no arguments")
