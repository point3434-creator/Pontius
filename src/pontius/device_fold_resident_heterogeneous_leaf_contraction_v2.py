"""Successor resident leaf contraction with validated record folding.

The numerical pipeline matches the historical device-fold contraction, but its
terminal record boundary delegates only to the finite, topology-owned v2 fold.
"""
...
def contract_device_fold_resident_heterogeneous_leaf_terms_v2(
    ...
    *,
    ...
    folded = finalize_resident_record_accumulators_v2(
        workspace,
