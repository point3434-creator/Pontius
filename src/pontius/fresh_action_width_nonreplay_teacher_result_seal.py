"""Committed identities for ADR-0336's solver-free teacher result owner."""

from types import MappingProxyType


ADR0336_TEACHER_RESULT_SOURCE_MANIFEST = MappingProxyType({
    ...
    "fresh_action_width_nonreplay_teacher_seal.py": (
        "2b9310740f2550d262845816788783b2f9a29bb27dc65dc336e118edb0e2ed0f"
    ),
    "fresh_action_width_nonreplay_teacher_result.py": (
        "5217e2264eb90050fdd836fc79db99de93015f9d9b1b8ca72ef6f83ddab5c558"
    ),
})
ADR0336_TEACHER_RESULT_PROTOCOL_SHA256 = (
    "e96cf304c6cc02c4cc2f03d6d7da30ee1396910b6e61a5028e344f3fb8edb949"
)
